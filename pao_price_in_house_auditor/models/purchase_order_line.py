        ...
        for rec in self:
            ...
            if not rec.product_id._origin.id:
                ...
                seller = product._select_seller(
                    ...
                    params=params)
                if seller:
                    price_unit = rec.env['account.tax']._fix_tax_included_price_company(seller.pao_price_in_house_auditor, product.supplier_taxes_id, rec.taxes_id, rec.company_id) if seller else 0.0
