...
class Fiel(models.Model):
    _name = 'pao.l10n_mx_edi.fiel'
    _description = 'PAO SAT Digital Fiel'
    _order = "date_start desc, id desc"

    content = fields.Binary(
        string='Fiel Certificate',
        help='Fiel Certificate in .cer format',
        required=True,
        attachment=False,
    )
    ...
    key = fields.Binary(
        string='Fiel Certificate Key',
        help='Fiel Certificate Key in .key format',
        required=True,
        attachment=False,
    )
