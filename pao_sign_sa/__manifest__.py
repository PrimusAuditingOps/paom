# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'reports/sa_header_footer_fsma_usa.xml',
        'reports/sa_header_footer_gfs_spanish.xml',
        'reports/sa_header_footer_gfs_usa.xml',
        'reports/sa_header_footer_gfs.xml',
        'reports/sa_header_footer_ggap.xml',
        'reports/sa_header_footer_globalgap_cert008_es.xml',
        'reports/sa_header_footer_globalgap_cert008.xml',
        ...
        'reports/sa_header_footer_smeta_es.xml',
        'reports/sa_header_footer_smeta_usa.xml',
        'reports/sa_header_footer_smeta.xml',
        'reports/sa_header_footer_standard_spanish.xml',
        'reports/sa_header_footer_standard_usa.xml',
        ...
        'views/sa_fsma_scheme_usa.xml',
        'views/sa_globalgap_cert008_scheme_spanish.xml',
        'views/sa_globalgap_cert008_scheme.xml',
        ...
        'views/sa_pgfs_scheme_spanish.xml',
        'views/sa_pgfs_scheme_usa.xml',
        'views/sa_pgfs_scheme.xml',
        'views/sa_portal_template.xml',
        'views/sa_primus_standar_scheme_spanish.xml',
        'views/sa_primus_standar_scheme_usa.xml',
