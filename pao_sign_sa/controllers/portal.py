...
class CustomerPortal(portal.CustomerPortal):
    ...
    def portal_sign_sa_pending_signature(self, report_type=None, sa_id=False, sa_token=None, download=False, **kw):
        ...
        return request.render('pao_sign_sa.pao_sign_sa_signature_pending_coordinator_page_view', {})
