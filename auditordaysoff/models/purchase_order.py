...
class PurchaseOrder(models.Model):
    ...
    shadow_id = fields.Many2one(string="Shadow", comodel_name='res.partner',
                                ondelete='set null')
    assessment_id = fields.Many2one(string="Assessment", comodel_name='res.partner',
                                    ondelete='set null')
    ado_is_external_audit = fields.Boolean(string = "Is an external audit",
                                           default = False)
    ado_is_auditor = fields.Boolean(related='partner_id.ado_is_auditor')
