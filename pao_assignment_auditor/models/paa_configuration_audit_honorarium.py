...
class PaaConfigurationAuditHonorarium(models.Model):
    ...
    first_month_audit_honorarium= fields.Integer(string="First Trimester",
                                                 default=0)
    second_month_audit_honorarium = fields.Integer(string="Second Trimester",
                                                   default=0)
    third_month_audit_honorarium = fields.Integer(string="Third Trimester",
                                                  default=0)
    fourth_month_audit_honorarium = fields.Integer(string="Fourth Trimester",
                                                   default=0)
