...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_followup_report_columns_name(self):
        """ Return the name of the columns of the follow-ups report
            Add new currency name column to the header
        """
        headers = super(AccountFollowupReport, self)._get_followup_report_columns_name()
        headers.append({'name': _('Currency'), 'style': 'text-align:center; white-space:nowrap;'})
        return headers
    
    def _get_followup_report_lines(self, options):
        """ Compute and return the lines of the columns of the follow-ups report.
            Replace base function from account_followup
        """
        ...
        for currency, aml_recs in res.items():
            ...
            for aml in aml_recs:
                ...
                invoice_date = {
                    'name': format_date(self.env, aml.date, lang_code=lang_code),
                    'class': 'date',
